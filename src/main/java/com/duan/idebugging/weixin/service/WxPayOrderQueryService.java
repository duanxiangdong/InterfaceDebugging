package com.duan.idebugging.weixin.service;

import java.util.Map;
import java.util.UUID;


import com.duan.idebugging.util.http.HttpclientUtil;
import com.duan.idebugging.weixin.bean.WxPayOrderQuery;
import com.duan.idebugging.weixin.bean.WxPayOrderQueryResult;
...
public class WxPayOrderQueryService {
    ...
    public static void main(String[] args) {
        ...
        try {
            String responseXml = HttpclientUtil.postXml(testUrl, requestXml, "utf8");
