...
public class HttpclientBaseConfig extends HttpclientBaseBuilder {
    private static final Logger log = Logger.getLogger(HttpclientBaseConfig.class);
     ...
     */
    protected static final UrlEncodedFormEntity setReqParams(Map<String, String> params) throws UnsupportedEncodingException {
        ...
        try {
            return new UrlEncodedFormEntity(paramsList, "utf8");
     ...
     * @throws IOException
     */
    protected static void close(HttpEntity entity, HttpRequestBase request, CloseableHttpResponse response) throws IOException {
        if (null != request) {
